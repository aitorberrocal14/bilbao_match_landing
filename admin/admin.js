/* =============================================================================
   ...
   Publishing
   ----------
   If admin/save.php answers, "Publicar" writes the files straight to the
   server. Otherwise it downloads the ones that changed, to be uploaded by FTP
   into assets/js/data/. Both paths produce the same files.
   ========================================================================== */
...
(function () {
        ...
        return '<div class="card"><h2>La web ahora mismo</h2><div class="stats">' +
          ...
          '<div class="card"><h2>Lo que este panel no toca</h2>' +
            ...
            '<ul class="muted">' +
              ...
              '<li><b>Las imágenes</b> — se editan las rutas, no los archivos. Una foto o un ' +
                'logo nuevo se sube por FTP a <code>assets/img/</code> y aquí se escribe su ruta.</li>' +
              '<li><b>Los expositores, cuando se conecte Meetmaps</b> — pasarán a llegar solos ' +
                'desde la plataforma. Hasta entonces se editan en su pantalla.</li>' +
            '</ul>' +
          '</div>';
      }
    },
        ...
        },
        {
          ...
          fields: [
            { t: 'image', k: 'site.hero.media.image', label: 'Fotografía',
              hint: 'Ruta desde la raíz de la web. La imagen se sube antes por FTP a <code>assets/img/photos/</code>.' },
      ...
      cards: [
        {
          ...
          fields: [
            { t: 'note', kind: 'warn', html:
              ...
              '<p class="muted">Cuando se conecte Meetmaps, esta lista llegará sola desde la ' +
              'plataforma y esta pantalla pasará a ser solo de consulta.</p>' }
          ]
        },
        {
          plain: true,
            ...
            { t: 'coll', k: 'exhibitors', itemLabel: 'Empresa',
              ...
              fields: [
                ...
                { t: 'image', k: 'logo', label: 'Logotipo',
                  hint: 'Se sube antes por FTP a <code>assets/img/exhibitors/</code>.' },
                { t: 'row', fields: [
            ...
            { t: 'coll', k: 'discover.brochures', itemLabel: 'Folleto',
              ...
              fields: [
                ...
                { t: 'image', k: 'cover', label: 'Portada',
                  hint: 'Se sube por FTP a <code>assets/img/brochures/</code>.' },
  ...
  function renderPublish() {
    ...
    if (saver === true) {
      ...
      how = '<div class="card"><h2>Publicar en la web</h2>' +
        '<p>Este panel no puede escribir en el servidor' +
          (saver === false ? ' (no está configurado el guardado directo)' : '') +
          ', así que se descargan los archivos que han cambiado y se suben por FTP.</p>' +
        '<ol>' +
          '<li>Pulsa <b>Descargar los cambios</b>. El navegador guardará uno o varios archivos ' +
            '<code>.js</code> en tu carpeta de descargas.</li>' +
          '<li>Conéctate por FTP y entra en la carpeta <code>assets/js/data/</code> de la web.</li>' +
          '<li>Sube ahí los archivos descargados, reemplazando los que hay.</li>' +
          '<li>Recarga la web para comprobarlo.</li>' +
        '</ol>' +
        '<div class="actions">' +
  ...
  function probeSaver() {
    ...
    if (location.protocol === 'file:') { saver = false; return; }
