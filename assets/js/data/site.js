...
window.MBB.site = {
  ...
  newsletter: {
    ...
    audiences: [
      {
        label: 'Basque supplier',
        note: 'Companies of the Bilbao Bizkaia destination',
        url: 'https://bilbaoturismo.us17.list-manage.com/subscribe?u=5be092a34755c7cdec316f8cf&id=35fe8d2bdf'
      },
      {
        label: 'International trade agent',
        note: 'Buyers, tour operators and media',
    ...
    // aquí no se recoge nada. Esta línea solo avisa de a dónde lleva el enlace.
    consent: 'Both forms open on the Bilbao Turismo mailing platform.'
  }
};
