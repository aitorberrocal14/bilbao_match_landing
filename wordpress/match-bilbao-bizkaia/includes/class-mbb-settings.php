...
class MBB_Settings {
		...
		return array(
			'event' => array(
				...
				'fields' => array(
					...
					'prog_intro'  => array( __( 'Programme introduction', 'mbb' ), 'textarea' ),
			...
			'links' => array(
				...
				'fields' => array(
					...
					'newsletter_action' => array( __( 'Newsletter form endpoint', 'mbb' ), 'url', __( 'Leave empty to hide the newsletter block.', 'mbb' ) ),
				),
			),
			'video' => array(
	...
	public static function defaults() {
		return array(
			...
			'day1_label'   => 'Day 1',
			'day1_date'    => 'Monday 8 June',
			'day1_theme'   => 'Welcome & the city',
			'day2_label'   => 'Day 2',
			'day2_date'    => 'Tuesday 9 June',
			'day2_theme'   => 'Business & the coast',
			'day3_label'   => 'Day 3',
			'day3_date'    => 'Wednesday 10 June',
			'day3_theme'   => 'Nature & next steps',
			'prog_intro'   => 'Three days built around one idea: fewer, better conversations. Mornings are dedicated to structured B2B meetings, afternoons to experiencing the destination first hand.',
			'prog_note'    => 'All times are shown in CET (Central European Time). The final programme will be confirmed to registered participants by email.',
			'calendar_url' => '',
			'hero_kicker'   => '8 – 10 June 2026 · Bilbao, Basque Country',
			'hero_title'    => 'Match Bilbao Bizkaia',
			'hero_year'     => '2026',
			'hero_subtitle' => 'The official professional meeting point of the Bilbao Bizkaia destination.',
			'hero_lead'     => 'Three days of curated B2B meetings, destination knowledge and shared discovery, bringing international buyers together with the tourism professionals who know Bilbao Bizkaia best.',
			'hero_image'    => 0,
			'fact1_value' => '39+', 'fact1_label' => 'Local exhibitors',
			'fact2_value' => '3',   'fact2_label' => 'Days of programme',
			'fact3_value' => '4',   'fact3_label' => 'Destination pillars',
			'fact4_value' => '1:1', 'fact4_label' => 'Pre-scheduled meetings',
			'login_url'     => '',
			'login_label'   => 'Login',
			...
			'video1_caption' => 'Highlights of the latest edition: three days of meetings, destination visits and new business connections.',
			'video2_id'      => '',
